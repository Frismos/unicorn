...
//                gameStage.comboLabel.setText(gameStage.game.strings.addString("score: ").addString(gameStage.score).toString());
//            }
//        }
//
//        @Override
...
//        skeletonActor.getSkeleton().getRootBone().setScale(gameStage.background.getWidth() / (GameStage.COLUMN_LENGTH - 1) / Constants.TILE_WIDTH,
//                gameStage.background.getHeight() / GameStage.ROW_LENGTH / Constants.TILE_WIDTH);


        setSize(gameStage.background.getWidth() / (GameStage.COLUMN_LENGTH - 1),
